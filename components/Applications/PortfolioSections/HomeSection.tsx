  ...
  return (
    <div className="p-4 space-y-6 text-sm">
      <section className="text-center p-6 y2k-raised bg-gray-100">
        <h1 className="text-3xl font-bold text-blue-700 mb-2 animate-pulse">JOSHUAWAYNE'S DIGITAL DOMAIN!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        <div className="md:col-span-1 flex justify-center">
          ...
          <div className="w-40 h-40 y2k-sunken bg-gray-300 flex items-center justify-center text-gray-500">
